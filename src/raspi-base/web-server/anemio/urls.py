...
router.register(r'telemetry/humidity', views.HumidityViewSet)
...
router.register(r'telemetry/rain/gauge/values', views.RainGaugeViewSet)
router.register(r'telemetry/rain/pad/state', views.RainStateViewSet)
router.register(r'telemetry/rain/pad/values', views.RainValuesViewSet)
router.register(r'telemetry/temperature', views.TemperatureViewSet)
router.register(r'telemetry/water/temperature', views.WaterTemperatureViewSet)
